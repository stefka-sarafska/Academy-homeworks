...
public class Task3_PersonCharacteristics {
	...
	private static Person createPerson(String[] input) throws PersonCharacteristicsException {
		...
		if ("P".equals(codeForEducation)) {
			...
			education = new HigherEducation(graduated, enrollmentDate, graduationDate, institutionName, EducationDegree.Bachelor, finalGrade);
		} else if ("M".equals(codeForEducation)) {
			education = new HigherEducation(graduated, enrollmentDate, graduationDate, institutionName,EducationDegree.Master, finalGrade);
		} else if ("D".equals(codeForEducation)) {
			education = new HigherEducation(graduated, enrollmentDate, graduationDate, institutionName, EducationDegree.Doctorate, finalGrade);
		} else {
